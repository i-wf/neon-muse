...
export const AI_MODELS: AIModel[] = [
  {
    ...
    name: "Flash Lite",
    nameAr: "فلاش لايت",
    description: "Ultra fast - Good for simple images",
    descriptionAr: "سريع جداً - جيد للصور البسيطة",
    tier: "free",
  ...
  },
  {
    ...
    descriptionAr: "جودة عالية - الأفضل للصور التفصيلية",
    tier: "free",
  ...
  },
  {
    ...
    name: "Gemini 3 Pro",
    nameAr: "جيميني 3 برو",
    description: "Next-gen quality - Advanced generation",
    descriptionAr: "جودة الجيل التالي - توليد متقدم",
    tier: "pro",
  ...
  },
  {
    ...
    name: "Gemini 3 Image",
    nameAr: "جيميني 3 صور",
    description: "Premium image gen - Best quality output",
    descriptionAr: "توليد صور ممتاز - أفضل جودة",
    tier: "pro",
  ...
  },
  {
    ...
    description: "Fast OpenAI - Quick generations",
    descriptionAr: "أوبن إيه آي سريع - توليد سريع",
    tier: "free",
  ...
  },
  {
    ...
    description: "Balanced OpenAI - Great quality",
    descriptionAr: "أوبن إيه آي متوازن - جودة ممتازة",
    tier: "free",
  ...
  },
  {
    ...
    name: "GPT-5",
    nameAr: "جي بي تي-5",
    description: "Top tier OpenAI - Maximum quality",
    descriptionAr: "أوبن إيه آي متقدم - أقصى جودة",
    tier: "pro",
